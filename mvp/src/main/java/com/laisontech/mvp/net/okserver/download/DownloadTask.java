...
import com.laisontech.mvp.net.okserver.okhttp.exception.HttpException;
import com.laisontech.mvp.net.okserver.okhttp.exception.OkGoException;
import com.laisontech.mvp.net.okserver.okhttp.exception.StorageException;
...
import com.laisontech.mvp.net.okserver.task.PriorityRunnable;
...
public class DownloadTask implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            if (request == null) {
                postOnError(progress, new Exception("request is null!"));
                return;
            }
    ...
    private void postOnError(Progress progress, final Throwable throwable) {
        ...
        HttpUtils.runOnUiThread(new Runnable() {
            ...
            public void run() {
                for (DownloadListener listener : listeners.values()) {
                    ...
                    listener.onError(finalProgress);
                }
            }
        });
    }
