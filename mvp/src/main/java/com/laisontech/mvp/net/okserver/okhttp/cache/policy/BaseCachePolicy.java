...
import com.laisontech.mvp.net.okserver.okhttp.db.CacheManager;
...
import com.laisontech.mvp.net.okserver.okhttp.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    protected void runOnUiThread(Runnable run) {
        OkServer.getInstance().getDelivery().post(run);
    }
