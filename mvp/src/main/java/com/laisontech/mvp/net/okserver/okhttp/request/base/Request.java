...
import com.laisontech.mvp.net.okserver.okhttp.adapter.AdapterParam;
import com.laisontech.mvp.net.okserver.okhttp.adapter.CacheCall;
import com.laisontech.mvp.net.okserver.okhttp.adapter.Call;
import com.laisontech.mvp.net.okserver.okhttp.adapter.CallAdapter;
...
import com.laisontech.mvp.net.okserver.okhttp.convert.Converter;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public Request(String url) {
        this.url = url;
        baseUrl = url;
        OkServer go = OkServer.getInstance();
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = OkServer.getInstance().getOkHttpClient();
